            ...
            <header>
                ...
                <nav class="menu">
                    <div class="lista-content">
                        <ul>
                            <li><a href="../index.html" class="enlc1">Inicio</a></li>
                            <li><a href="#" class="activo">Noticias</a></li>
                            <li><a href="login.php" class="enlc3">Login</a></li>
                            <li><a href="registro.php" class="enlc4">Registro</a></li>
                        </ul>
                    </div>
                </nav>
            </header>
        ...
        <div class="noticias">
            ...
            if ($result->num_rows === 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<p class='texto_2'>" . htmlspecialchars($row["fecha"]) . "</p>";

                    // Mostrar nombre del usuario si está disponible
                    if (isset($row["idUser"])) {
                        echo "<p class='autor'>Autor: " . htmlspecialchars($row["idUser"]) . "</p>";
                    } else {
